...
class ProcessGraph {
      ...
      processItem.innerHTML = `
        <div class="flex items-start justify-between">
          ...
          <div class="flex gap-1 ml-2">
            <button onclick="event.stopPropagation(); processModal.showEditModal(${process.process_id})" class="p-2 hover:bg-accent rounded-md transition-colors">
  ...
  // Modal related methods have been moved to ProcessModal.js
}
...
function attachProcessEventListeners() {
  ...
  if (addProcessBtn) {
    addProcessBtn.addEventListener('click', () => processModal.showAddModal());
  }
